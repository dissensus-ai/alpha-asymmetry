...
position rather than as an asymmetry harvester. Transaction costs make an already negative gross
...
\begin{enumerate}
    ...
    \item While invested, the corrected strategy loads significantly and negatively on time-series momentum ($\beta_2 = -0.82$, $t = -3.73$), a loading absent before correction; it behaves substantially as a short momentum position rather than as an asymmetry harvester, so part of its loss is a known factor exposure rather than a failure specific to asymmetry
